...
% Colouring areas
                    ...
                    \fill[cyan, opacity = 0.25] (4.3, 0) -- (5, 0) -- (5, 5.56) -- (4.3, 5.56);
                    \fill[cyan, opacity = 0.1] (4.3, 0) -- (4.3, 5.56) -- (1.5, 5.56) -- (1.5, 0);
...
% Legend
                    ...
                    \fcolorbox{black}{cyan!25}{\makebox[\fontcharht\font`X]{$G$}} : $W_T$ loss \\ \\
                          Stage 2 \\
                    \fcolorbox{black}{green!25}{\makebox[\fontcharht\font`X]{$A$}} : $W_T$ gain \\
                    \fcolorbox{black}{cyan!10}{\makebox[\fontcharht\font`X]{$F$}} + \fcolorbox{black}{cyan!25}{\makebox[\fontcharht\font`X]{$G$}} : $W_T$ loss 
                     };
                            \end{axis}
